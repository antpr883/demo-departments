...
import com.demo.departments.demoDepartments.DemoDepartmentsApplication;
import com.demo.departments.demoDepartments.persistence.repository.impl.BaseCustomJpaRepositoryImpl;
...
public class BaseRepositoryAutoConfiguration {
    ...
    * */
    @Configuration
    @EntityScan(basePackageClasses = DemoDepartmentsApplication.class) // Сканування сутностей у пакеті DemoShopApplication
    @EnableJpaRepositories(
            basePackageClasses = DemoDepartmentsApplication.class, // Вмикає JPA репозиторії
